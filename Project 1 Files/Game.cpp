//Game.cpp
//To create a Game, you specify a number of rows and columns and
//and the number of rabbits to start with. The Game object creates an
//appropriately sized arena and populates it with the Player and the Rabbits.

//A game amy be played
#include "globals.h"
#include "Arena.h"
#include "Game.h"
#include "Player.h"

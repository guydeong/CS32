...
Sequence& Sequence::operator=(const Sequence& other) {
	...
	//Swap the maximum sizes, sizes, and array size
	this->m_MaxSize = other.m_MaxSize;
	this->m_size = other.m_size;
	delete[] m_arr;
	this->m_arr = new ItemType[other.m_MaxSize];
...
int Sequence::insert(int pos, const ItemType& value) {
	//Insert value into the sequence so that it become the item at position pos
...
void Sequence::swap(Sequence& other) {
	...
	int temp_MaxSize = this->m_MaxSize;
	ItemType *temp_arr = this->m_arr;
